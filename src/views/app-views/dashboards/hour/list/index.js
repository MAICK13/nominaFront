...
import HourService, {handleDownload} from "../../../../../services/HourService";
...
const showConfirm = (rowID) => {
    ...
    confirm({
        ...
        cancelText: 'Cancelar',
        async onOk() {
            const response = await HourService.delete(rowID)
...
export const DefaultJob = () => {
    ...
    useEffect(() => {
        HourService.list().then(result => setDataResult(result))
    }, []);
