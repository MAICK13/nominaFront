...
export const EditWorkArea = () => {
    ...
    useEffect(() => {
        AreaService.get_area(params.id).then(result => {
            form.setFieldsValue({
    ...
    const onFinish = async values => {
        const response = await AreaService.edit(values, params.id)
