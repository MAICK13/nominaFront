...
export const AddEmployeePhone = () => {
    ...
    useEffect(() => {
        EmployeeEmailService.get_employee_email(params.id).then(result => {
            form.setFieldsValue({
                email_type: result.email_type,
                email_indicator: result.email_indicator,
    ...
    const onFinish = async values => {
        const response = await EmployeeEmailService.edit(values, params.id)
