...
export const AddEmployeePhone = () => {
    ...
    useEffect(() => {
        EmployeeAddressService.get_employee_address(params.id).then(result => {
            form.setFieldsValue({
                address_type: result.address_type,
                employee_address: result.employee_address,
                address_indicator: result.address_indicator,
    ...
    const onFinish = async values => {
        const response = await EmployeeAddressService.edit(values, params.id)
